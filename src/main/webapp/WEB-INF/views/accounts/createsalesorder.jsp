					...
					<div class="col-sm-2">
						<div class="form-group">
							<label class="required">Consignee</label> <select
								name="consigneeId" id="cFirstsalesName"
								class="form-control select2 salesData" style="width: 100%;"
					...
					<div class="col-sm-2">
						<div class="form-group">
							<label>Notify Party</label> <select name="notifypartyId"
								id="npFirstsalesName" class="form-control select2 salesData"
							...
							<div class="col-md-3">
								<div class="form-group">
									<label>Total</label> <input type="text" name="total"
										class="form-control calculation autonumber"
										data-a-sign="&yen; " style="width: 150px;" /> <span
										class="help-block"></span>
								</div>
							</div>
						</div>
