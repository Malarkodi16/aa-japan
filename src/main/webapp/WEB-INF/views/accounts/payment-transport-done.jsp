		...
		<div class="box-body">
			...
			<div class="container-fluid">
				<div class="row form-group">
					<div class="col-md-2">
						<label>Transporter</label> <select name="transporter"
							id="transporter" class="form-control transporter select2"
							data-placeholder="Transporter">
							<option value=""></option>
						</select>
					</div>
					<div class="col-md-2">
			...
			<div class="container-fluid" id="transport-invoice-list">
				<div class="table-responsive">
					...
					<table id="table-transport-invoice-completed"
						...
						<thead>
							<tr>
								...
								<th data-index="3" class="align-center">Invoice No</th>
								<th data-index="4" class="align-center">Payment Voucher No</th>
								...
								<th data-index="8" class="align-center">Transporter</th>
								<th data-index="9" class="align-center">Payment Status</th>
