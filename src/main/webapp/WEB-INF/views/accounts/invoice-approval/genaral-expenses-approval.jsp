		...
		<div class="box-body">
			<div class="container-fluid">
				<div class="row form-group">
					<input type="hidden" name="pageName" value="general-expense-approval" />
					
					<div class="col-md-2">
						<div class="form-group">
							<label>Supplier</label> <select id="table-filter-remitter"
								class="form-control pull-right" placeholder="Select Remiter">
								<option value=""></option>
							</select>
						</div>
					</div>
					...
					<table id="table-payment-others-invoice"
						...
						<thead>
							<tr>
								...
								<th data-index="4" class="align-center">Supplier</th>
										...
										<tr class="clone-row hide">
											...
											<td>
												<div class="element-wrapper">
													<input type="text"
														...
														name="amountInYen" data-a-sign="¥ " data-v-min="0"
											...
											<td><div class="element-wrapper">
													<input type="text" class="form-control autonumber amount"
														name="amount" data-v-min="0" data-m-dec="0"><span
														class="help-block"></span>
												</div></td>
											<td><div class="element-wrapper">
													<input type="text"
									...
									<tfoot>
										<tr>
											...
											<td class="align-center amountInYenTotal"><span
												...
												data-a-sign="¥ " data-v-min="0"></span></td>
											<td></td>
											<td></td>
											<td class="align-center taxTotal"><span
												class="autonumber taxTotal" data-m-dec="0" data-a-sign="¥ "
												data-v-min="0"></span></td>
