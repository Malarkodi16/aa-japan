					...
					<table id="table-transport-invoice"
						...
						<thead>
							<tr>
								...
								<th data-index="4" class="align-center">Invoice No</th>
				...
				<div class="modal-body">
					<form id="edit-payment-form">
						<div class="container-fluid">
							...
							<div class="row">
								<input type="hidden" name="invoiceRefNo" id="invoiceRefNo"
									class="form-control required invoiceRefNo" /> <input
									type="hidden" name="preRefNo" id="preRefNo"
									class="form-control required preRefNo" />
								<div class="col-md-4 ">
									<div class="form-group">
										<label class="required">Due Date</label>
										<div class="element-wrapper">
