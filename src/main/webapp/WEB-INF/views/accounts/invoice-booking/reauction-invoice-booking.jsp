<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="#">Invoice Booking &amp; Approval</li>
						...
						<div class="modal-body">
							<form action="#">
								<div class="row form-group" id="priceDetails">
									...
									<div class="col-md-3">
										<div class="form-group">
											<label class="required">Sold Price</label> <input type="text"
												name="soldPrice" id="amount" data-validation="number"
								...
								<div class="row form-group">
									...
									<div class="col-md-3">
										<div class="form-group">
											<label class="required">Shuppin Tax</label><input type="text"
												name="shuppinTax" id="shuppinTax" data-validation="number"
												class="form-control required autonumber" data-v-min="0"
												data-a-sign="¥ " readonly="readonly" /> <span
												class="help-block"></span>
										</div>
									...
									<div class="col-md-3">
										<div class="form-group">
											<label class="required">Sold Tax</label><input type="text"
												name="soldCommTax" id="soldCommTax" data-validation="number"
												class="form-control required autonumber" data-v-min="0"
												data-a-sign="¥ " readonly="readonly" /> <span
												class="help-block"></span>
										</div>
								...
								<div class="col-md-3">
									<div class="form-group">
										<label>Stock No</label> <input type="text" name="stockNo"
											id="stockNo" class="form-control stockNo" readonly="readonly" />
										<span class="help-block"></span>
									</div>
								</div>
								<div class="col-md-3">
