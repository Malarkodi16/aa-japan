			...
			<fieldset id="sales-details">
				<div class="row">
					<input type="hidden" name="invoiceNo" id="invoiceNo"
						class="form-control salesData" value="" />
					<div class="col-sm-3">
						<div class="form-group">
							<label class="required">Customer</label><select name="customerId"
								id="customerId" class="form-control select2-select salesData"
								style="width: 100%;"
					...
					<div class="col-sm-3">
						<div class="form-group">
							<label class="required">Consignee</label> <select
								name="consigneeId" id="cFirstName"
					...
					<div class="col-sm-2">
						<div class="form-group">
							<label>Notify Party</label> <select name="notifypartyId"
								id="npFirstName" class="form-control select2-select salesData"
								style="width: 100%;" data-value=""
							...
							<div class="col-md-2">
								<div class="form-group">
									<input type="text" name="total" id="total"
										class="form-control calculation autonumber"
										data-a-sign="&yen; " /> <span class="help-block"></span>
								</div>
							</div>
							<div class="col-md-1">
								<div class="form-group">
