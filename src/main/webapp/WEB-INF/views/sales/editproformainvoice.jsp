...
<form action="#" id="edit-proforma-form">
	<div class="box-body">
							...
							<div class="input-group">
								<div class="elemenr-wrapper" style="width: 80%;">
									<select name="consigneeId" id="cFirstName"
										...
										data-value="" data-placeholder="Select Consignee">
										<option value=""></option>
									</select>
								</div>
							...
							<div class="input-group">
								<div class="elemenr-wrapper" style="width: 80%;">
									<select name="notifypartyId" id="npFirstName"
										class="form-control select2 invoiceData" style="width: 150px;"
										data-placeholder="Select Notify Party" data-value="">
										<option value=""></option>
									</select>
								</div>
					...
					<div class="col-sm-2">
						<div class="form-group">
							<label>Payment Type</label> <select
								class="form-control select2 invoiceData select2-select"
