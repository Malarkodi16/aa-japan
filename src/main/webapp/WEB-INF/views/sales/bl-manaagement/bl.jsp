...
<section class="content">
	<div class="box box-solid">
		...
		<div class="box-body">
			<div class="container-fluid">
				<input type="hidden" name="pageName" value="sales">
						...
						<div class="pull-right">
							<div class="form-group">
								<button class="btn btn-primary" name="update-bl-amend-in-group"
									...
									data-target="#modal-update-bl-amend">Bl Amend</button>
			...
			<div class="table-responsive">
				<table id="table-bl-data" class="table table-bordered table-striped"
	...
	<!-- 	.modal -->
	<div class="modal fade" id="modal-update-bl-amend">
	...
	<div class="modal fade" id="modal-bl-transaction-list">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body" id="blTransactionDetails">
					<input type="hidden" name="shippingInstructionId"> <input
						type="hidden" name="rowData" />
					<div class="container-fluid">
						<div class="table-responsive">
							<table id="table-bl-transaction-data"
