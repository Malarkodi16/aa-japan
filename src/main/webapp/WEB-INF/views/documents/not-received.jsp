...
<section class="content">
	<sec:authorize access="canAccessAny(122,123,124,125,126)">
						...
						<form id="stock-edit-detail">
							<div class="container-fluid">
								<div class="row form-group">
									...
									<div class="col-md-3">
										<div class="form-group">
											<label>Plate Received Date</label> <input type="text"
												name="plateNoReceivedDate"
												class="form-control datepicker1" /> <span
												class="help-block"></span>
										</div>
								...
								<div class="row form-group">
									...
									<!-- <div class="col-md-2">
										<div class="form-group">
											<label>Edit Chassis No. Only</label>
											<div>
												<input type="checkbox" name="editChassisNo"
													id="editChassisNo" class="editChassisNo" />
											</div>
										</div>
									</div> -->
									<div class="col-md-3">
