...
<section class="content">
	<sec:authorize access="canAccessAny(91,92)">
			...
			<div class="box-body">
					...
					<div class="row form-group">
						...
						<div class="col-md-2">
							<div class="form-group" id="bl-status">
								<label>Status</label> <select name="blStatus"
									class="form-control select2 status" data-placeholder="Status">
									<option value=""></option>
						...
						<div class="col-md-8">
							<div class="pull-right">
								<button type="button" id="update-status" class="btn btn-primary">
									<i class="fa fa-fw fa-save" title="BL Status Update"></i>
									Update Status
								</button>
							</div>
						</div>
				...
				<div class="container-fluid">
					<div class="table-responsive">
						<table id="table-document-draft-list"
