<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">Port Management</li>
	</ol>
</section>
<!--Port List-->
			...
			<div class="box-header with-border">
				<div class="container-fluid">
					<div class="pull-right">
						<button class="btn btn-primary" id="new_port" type="button"
							data-backdrop="static" data-keyboard="false" data-toggle="modal"
							data-target="#modal-add-port">Create Port</button>
					</div>
				</div>
			</div>
		</form>
		<div class="box-body">
			<div class="container-fluid ">
				...
				<div class="table-responsive">
					<table id="table-master-port-list"
									...
									<div class="form-group">
										...
										<div class="element-wrapper">
											<div class="input-group">
												...
												<select class="form-control select2" id="continent"
													name="continent" data-placeholder="Select Continent">
													<option value=""></option>
												</select>
											</div>
										</div>
										...
										<div class="element-wrapper">
											<div class="input-group">
												...
												<input name="portName" id="portName"
													placeholder="Enter Port Name" type="text"
													class="form-control" />
											</div>
											<span class="help-block"></span>
										</div>
