			...
			<div class="box-header with-border">
				<div class="container-fluid">
					<div class="pull-right">
						<button class="btn btn-primary" id="new_transporter" type="button"
							data-backdrop="static" data-keyboard="false" data-toggle="modal"
							data-target="#modal-add-transporter">Create Transporter</button>
					</div>
				</div>
			</div>
		</form>
		<div class="box-body">
			<div class="container-fluid ">
				...
				<div class="table-responsive">
					<table id="table-master-transporter-list"
...
<form action="#" id="transporter-form">
	<div class="modal fade" id="modal-add-transporter">
