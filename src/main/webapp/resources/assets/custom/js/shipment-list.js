...
//                 data.continent = $('#searchCondition').find('select[name="continent"]').val();
        ...
        columnDefs: [{
            ...
            "render": function(data, type, row) {
                ...
                var html = '';
                if (type === 'display') {
                    html += '<a href="' + myContextPath + '/shipping/shipmentschedule/edit/' + data + '" class="ml-5 btn btn-info btn-xs"><i class="fa fa-fw fa-edit"></i></a>'
                    html += '<a href="#" class="ml-5 btn btn-warning btn-xs btn-delete"><i class="fa fa-fw fa-trash-o"></i></a>'
