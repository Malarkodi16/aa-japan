var tableStorage, remittersJson, suppliersJson, transportersJson, forwardersJson, generalSuppliersJson, insCompJson, invoiceTypeFlag;
$(function() {
...
function storageFormat(rowData) {
    var element = $('#storage-clone-container>#storage-invoice-details>.clone-element>.order-item-container').clone();
